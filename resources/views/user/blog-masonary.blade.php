    ...
    <div class="wrapper">
        ...
        <div id="content" class="main-content-wrapper">
            <div class="page-content-inner">
                <div class="container-fluid">
                    <div
                        class="row masonary-blog-layout pt--70 pt-md--50 pt-sm--40 pb--40 pb-xl--45 pb-md--25 pb-sm--20">
                        <div class="grid-sizer"></div>
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/image.jpg" alt="Blog">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-7.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-13.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-12.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-11.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-10-1000x600.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-8.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-9.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-5.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post format-video">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/post-2-1.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-14.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-6.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-3.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-2.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-1.jpeg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-4.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-f-1.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/post-1-1.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/blog-f-2.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
                        ...
                        <div class="grid-item">
                            <article class="post">
                                <div class="post-media">
                                    <div class="image">
                                        <img src="user_assets/img/blog/m2-s3-1.jpg" alt="Blog">
                                        <a href="single-post.html" class="link-overlay">Blog</a>
                                    </div>
                                </div>
                                <div class="post-info">
