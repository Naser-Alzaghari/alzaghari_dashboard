                                ...
                                <div class="product-data-tab border-bottom pb--40 pb-md--30 pb-sm--20 tab-style-4">
                                    <div class="nav nav-tabs product-data-tab__head mb--40 mb-sm--30" id="product-tab"
                                        ...
                                        <a class="product-data-tab__link nav-link" id="nav-reviews-tab"
                                            data-bs-toggle="tab" href="#nav-reviews" role="tab" aria-selected="true">
                                            <span>Reviews(1)</span>
                                        </a>
                                    </div>
                                        ...
                                        <div class="tab-pane fade show active" id="nav-description" role="tabpanel"
                                            ...
                                            <div class="product-description">
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas
                                                    ...
                                                    <p>Nunc lacus elit, faucibus ac laoreet sed, dapibus ac mi. Maecenas
                                                        eu ante a elit tempus fermentum. Aliquam commodo tincidunt
                                                        semper. Phasellus accumsan, justo ac mollis pharetra, ex dui
                                                        pharetra nisl, a scelerisque ipsum nulla ac sem. Cras eu risus
                                                        urna. Duis lorem sapien, congue eget nisl sit amet, rutrum
                                                        faucibus elit.</p>

                                                    <ul>
                                                        <li>Maecenas eu ante a elit tempus fermentum. Aliquam commodo
                                                            tincidunt semper</li>
                                                        <li>Aliquam est et tempus. Eaecenas libero ante, tincidunt vel
                                                        </li>
                                                    </ul>

                                                    <p>Curabitur sodales euismod nibh. Sed iaculis sed orci eget semper.
                                                        Nam auctor, augue et eleifend tincidunt, felis mauris convallis
                                                        neque, in placerat metus urna laoreet diam. Morbi sagittis
                                                        facilisis arcu sed ornare. Maecenas dictum urna ut facilisis
                                                        rhoncus.iaculis sed orci eget semper. Nam auctor, augue et
                                                        ...
                                                        <div class="review__container">
                                                            ...
                                                            <div class="review__text">
                                                                ...
                                                                <p class="review__description">Aliquam egestas libero ac
                                                                    ...
                                                                    Vestibulum ut sem laoreet, feugiat tellus at,
                                                                    hendrerit arcu.</p>
                                                            </div>
                                                        </div>
                                                    </li>
