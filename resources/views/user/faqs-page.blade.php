                                    ...
                                    <div class="col-lg-6">
                                        <div class="accordion__single mb--100 mb-lg--75 mb-md--55 mb-sm--40">
                                            <div class="accordion__header" id="headingOne">
                                                <a class="accordion__link" data-bs-target="#accordionOne">
                                        ...
                                        <div class="accordion__single mb--100 mb-lg--75 mb-md--55 mb-sm--40">
                                            <div class="accordion__header" id="headingTwo">
                                                <a class="accordion__link" data-bs-target="#accordionTwo">
                                                    Quisque ut nulla viverra, posuere lorem ?
                                                </a>
                                            </div>
                                        ...
                                        <div class="accordion__single mb--100 mb-lg--75 mb-md--55 mb-sm--40">
                                            <div class="accordion__header" id="headingThree">
                                                <a class="accordion__link" data-bs-target="#accordionThree">
                                                    Quisque ut nulla viverra, posuere lorem ?
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="accordion__single mb--100 mb-lg--75 mb-md--55 mb-sm--40">
                                            <div class="accordion__header" id="headingSix">
                                                <a class="accordion__link" data-bs-target="#accordionFive">
                                                    Quisque ut nulla viverra, posuere lorem ?
                                                </a>
                                            </div>
                                        ...
                                        <div class="accordion__single mb--100 mb-lg--75 mb-md--55 mb-sm--40">
                                            <div class="accordion__header" id="headingSeven">
                                                <a class="accordion__link" data-bs-target="#accordionSix">
                                                    Quisque ut nulla viverra, posuere lorem ?
                                                </a>
                                            </div>
