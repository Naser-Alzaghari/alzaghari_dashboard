                    ...
                    <div class="row pt--80 pb--40">
                        ...
                        <div class="col-lg-4 col-sm-6 mb--40 mb-md--30">
                            <div class="airi-team">
                                <div class="team-member">
                                    <div class="team-member__thumbnail">
                                        <img src="user_assets/img/team/member-7.jpg" alt="Team Member">
                        ...
                        <div class="col-lg-4 col-sm-6 mb--40 mb-md--30">
                            <div class="airi-team">
                                <div class="team-member">
                                    <div class="team-member__thumbnail">
                                        <img src="user_assets/img/team/member-8.jpg" alt="Team Member">
                                        <a href="#" class="link-overlay">Team member</a>
                                        <div class="team-member__overlay">
                                            <ul class="social social-round">
                                                <li class="social__item">
                        ...
                        <div class="col-lg-4 col-sm-6 mb--40 mb-md--30">
                            <div class="airi-team">
                                <div class="team-member">
                                    <div class="team-member__thumbnail">
                                        <img src="user_assets/img/team/member-9.jpg" alt="Team Member">
                                        <a href="#" class="link-overlay">Team member</a>
                                        <div class="team-member__overlay">
                                            <ul class="social social-round">
                                                <li class="social__item">
