                                            ...
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-20-1-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-20-2-568x653.jpg"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <p class="product-short-description">
                                                        ...
                                                        nesciunt quam totam, sapiente eveniet consectetur voluptas quas
                                                        harum impedit quia quibusdam tempora ab facilis. Non assumenda
                                                        veritatis,
                                                    </p>
                                                    <div class="product-btn-group">
                                                        <a href="cart.html" class="btn btn-medium btn-style-1">Add To
                                                            Cart</a>
                                                        <a href="wishlist.html" class="btn btn-medium btn-style-1">Add
                                                            To Wishlist</a>
                                                        <a href="compare.html" class="btn btn-medium btn-style-1">Add To
                                                            Compare</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="airi-product airi-product-list">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-19-4-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-19-1-568x653.jpg"
                                                                alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                        ...
                                        <div class="airi-product airi-product-list">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-18-1-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-18-4-568x653.jpg"
                                                                alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                        ...
                                        <div class="airi-product airi-product-list">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-17-1-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-17-4-568x653.jpg"
                                                                alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                        ...
                                        <div class="airi-product airi-product-list">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-16-4-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-16-1-568x653.jpg"
                                                                alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                        ...
                                        <div class="airi-product airi-product-list">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="user_assets/img/products/prod-15-1-568x653.jpg"
                                                                alt="Product Image" class="primary-image">
                                                            <img src="user_assets/img/products/prod-15-3-568x653.jpg"
                                                                alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
