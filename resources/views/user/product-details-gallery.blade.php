                                            ...
                                            <div class="row grid-space-10">
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="user_assets/img/products/prod-15-4.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="user_assets/img/products/prod-15-3-1.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="user_assets/img/products/prod-15-2.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="user_assets/img/products/prod-15-6.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-color-variations">
                                        ...
                                        <div class="product-color-swatch variation-wrapper">
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn blue"
                                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Blue">
                                                    <span class="product-color-swatch-label">Blue</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn green"
                                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Green">
                                            ...
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn red"
                                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Red">
