                                        ...
                                        <table class="table group-product-table">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty"
                                                            id="qty-1" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Limited edition v-neck
                                                            t-shirt</a></h3>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty"
                                                            id="qty-2" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Waxed-effect pleated skirt</a>
                                                    </h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
                                            ...
                                            <tr>
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty"
                                                            id="qty-3" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Chain print bermuda shorts</a>
                                                    </h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
