                            ...
                            <div class="single-post">
                                ...
                                <article class="single-post-details">
                                    ...
                                    <div class="entry-thumbnail">
                                        <img src="user_assets/img/blog/post-1-1.jpg" alt="Post Thumbnail">
                                    </div>
                                    <div class="entry-content">
                                        <p>Praesent sed ex vel mauris eleifend mollis. Vestibulum dictum sodales ante,
                                            ac pulvinar urna sollicitudin in. Suspendisse sodales dolor nec mattis
                                            convallis. Quisque ut nulla viverra, posuere lorem eget, ultrices metus.
                                            Nulla facilisi. Duis aliquet, eros in auctor aliquam, tortor justo laoreet
                                            nisi, nec pulvinar lectus diam nec libero. Nullam sit amet dia</p>
                                        <p>Cras porta posuere lectus, vitae consectetur dolor elementum id. Ut interdum,
                                            sem eget varius eleifend, ex risus gravida purus, sed finibus tortor nisi
                                            maximus orci. Etiam vel sollicitudin nisi. In ipsum tortor, vulputate nec
                                            est in, pharetra malesuada diam. Praesent ullamcorper lacinia ultrices.
                                            Etiam semper cursus mi, id tempor neque porta non. Praesent nec faucibus
                                            risus. Morbi aliquam hendrerit felis, eu cursus orci. Lorem ipsum dolor sit
                                            amet, consectetur adipiscing elit. Fusce et ante a felis egestas varius quis
                                            eget urna. Mauris blandit, sem venenatis blandit vehicula, neque leo
                                            eleifend ante, id porta enim odio sit amet dolor. Duis finibus magna id
                                            justo egestas tincidunt. Aliquam eu tristique lorem. Morbi rutrum accumsan
                                            sem, ut rhoncus tortor tincidunt eget. Phasellus eros massa, molestie id
                                            molestie a, maximus id tortor. Aenean sit amet arcu varius, elementum sapien
                                            ut, tristique est.</p>
                                        <p>Nullam viverra convallis tellus. Nulla fermentum dictum congue. Quisque enim
                                            felis, molestie ac tempor vel, auctor a magna. Sed viverra laoreet turpis,
                                            vitae pellentesque sem viverra sed. Integer posuere est a sem viverra</p>
                                        <div class="row mb--80 mb-lg--40">
                                            <div class="col-md-6">
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce et
                                                    ante a felis egestas varius quis eget urna. Mauris blandit, sem
                                                    venenatis blandit vehicula, neque leo eleifend ante, id porta enim
                                                    odio sit amet dolor. Duis finibus magna id justo egestas tincidunt.
                                                    Aliquam eu tristique lorem. Morbi rutrum accumsan sem
                                                </p>
                                                <ul class="list list-disc">
                                                    <li>Praesent sed ex vel mauris eleifend mollis. Vestibulum dictum
                                                        sodales ante, ac pulvinar urna sollicitudin in. Suspendisse
                                                        sodales dolor nec mattis conva.</li>
                                                    <li>Cras porta posuere lectus, vitae consectetur dolor elementum id.
                                                        Ut interdum, sem eget varius eleifend</li>
                                                </ul>
                                                <p>Porta enim odio sit amet dolor. Duis finibus magna id justo egestas
                                                    tincidunt. Aliquam eu tristique lorem. Morbi rutrum accumsan sem</p>
                                            </div>
                                            <div class="col-md-6 text-end">
                                                <img src="user_assets/img/blog/post-1-2.jpg" alt="blog">
                                            </div>
                                        </div>
                                        ...
                                        <p>Cras porta posuere lectus, vitae consectetur dolor elementum id. Ut interdum,
                                            ...
                                            eleifend ante, id porta enim odio sit amet dolor. Duis finibus magna id
                                            justo egestas tincidunt. Aliquam eu tristique lorem. Morbi rutrum accumsan
                                            sem, ut rhoncus tortor tincidunt eget.</p>
                                    </div>
                                    ...
                                    <div class="nav-links">
                                        <div class="nav-prev nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="user_assets/img/blog/m2-s3-1-100x100.jpg" alt="Prev Post">
                                            </div>
                                        ...
                                        <div class="nav-next nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="user_assets/img/blog/post-2-1-100x100.jpg" alt="Next Post">
                                            </div>
                                            <div class="nav-links__content">
                                    ...
                                    <div class="comment">
                                        <ul class="comment-list">
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="user_assets/img/others/comment-1.jpg" alt="comment">
                                                    </div>
                                                ...
                                                <ul class="children">
                                                    <li>
                                                        <div class="single-comment">
                                                            <div class="comment-avatar">
                                                                <img src="user_assets/img/others/comment-2.jpg"
                                                                    alt="comment">
                                                            </div>
                                                            <div class="comment-info">
                                                                <div class="comment-meta">
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="user_assets/img/others/comment-3.jpg" alt="comment">
                                                    </div>
                                                    <div class="comment-info">
                                                        <div class="comment-meta">
                                                            <h5 class="comment-author"><a href="#">Julia Rebeca</a></h5>
                                    ...
                                    <div class="comment-respond">
                                        ...
                                        <form action="#" class="form comment-form">
                                            <div class="form-notes mb--20">
                                                <p><em>Your email address will not be published. Required fields are
                                                        marked</em> <span class="required">*</span></p>
                                            </div>
                                            <div class="form__group mb--30 mb-sm--20">
                                                <div class="row">
                                                    <div class="col-md-4 mb-sm--20">
                                                        <label class="form__label form__label--3"
                                                            for="comment_name">Name<span
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form__label form__label--3"
                                                            for="comment_website">Website</label>
                                            ...
                                            <div class="form__group mb--30 mb-sm--20">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <label class="form__label form__label--3" for="review">Your
                                ...
                                <div class="widget blog-widget widget-recent-posts mb--40 mb-md--30 mb-sm--20">
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/image-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-13-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-12-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-11-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                ...
                <div class="container">
                    <div class="row pt--65 pb--55 pt-md--45 pb-md--35 pt-sm--35 pb-sm--25">
                        <div class="col-12">
                            ...
                            <div class="airi-element-carousel related-post" data-slick-options='{
                                    "spaceBetween": 30,
                                    "slidesToShow": 3,
                                    "slidesToScroll": 3
                                ...
                                <div class="item">
                                    <article class="blog blog-style-2">
                                        <div class="blog-media">
                                            <div class="image">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-f-1-500x478.jpg" alt="Blog Thumb">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="blog-info">
                                            ...
                                            <p class="blog__excerpt">Praesent sed ex vel mauris eleifend mollis.
                                                Vestibulum dictum sodales ante, ac pulvinar…</p>
                                        </div>
                                    </article>
                                </div>
                                <div class="item">
                                    <article class="blog blog-style-2">
                                        <div class="blog-media">
                                            <div class="image">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-11-500x478.jpg" alt="Blog Thumb">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="blog-info">
                                ...
                                <div class="item">
                                    <article class="blog blog-style-2">
                                        <div class="blog-media">
                                            <div class="image">
                                                <a href="single-post.html">
                                                    <img src="user_assets/img/blog/blog-f-2-500x478.jpg" alt="Blog Thumb">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="blog-info">
